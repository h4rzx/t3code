...
const configuredWorkspaceLayout = process.env.T3CODE_WORKSPACE_LAYOUT?.trim() || "";
...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      "import.meta.env.VITE_T3CODE_WORKSPACE_LAYOUT": JSON.stringify(configuredWorkspaceLayout),
