...
import Migration0033 from "./Migrations/033_ProjectionWorkspaces.ts";
import Migration0034 from "./Migrations/034_RebuildProjectionWorkspaces.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectionWorkspaces", Migration0033],
  [34, "RebuildProjectionWorkspaces", Migration0034],
] as const;
